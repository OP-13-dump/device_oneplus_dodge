...
blob_fixups: blob_fixups_user_type = {
    ...
    'odm/lib64/libEIS.so': blob_fixup()
        ...
        .binary_regex_replace(
            re.escape(b'\x84\x2e\x40\xb9\xe1\x8b\x44\x29\xe3\x2f\x40\xb9\x05\x40\x80\x52'),
            b'\x64\x04\x80\x52\xe1\x8b\x44\x29\xe3\x2f\x40\xb9\x05\x40\x80\x52',
        )
        .binary_regex_replace(
            re.escape(b'\x04\x2f\x40\xb9\x05\x20\x80\x52\x45\x00\xa0\x72\xe0\x03\x18\xaa'),
            b'\x64\x04\x80\x52\x05\x20\x80\x52\x45\x00\xa0\x72\xe0\x03\x18\xaa',
        )
        .binary_regex_replace(
            re.escape(b'\xff\x03\x00\xf9\x28\x10\x40\xf9\x04\x2c\x40\xb9\x01\x89\x40\x29\x86\xc2\xff\x97'),
            b'\xff\x03\x00\xf9\x28\x10\x40\xf9\x64\x04\x80\x52\x01\x89\x40\x29\x86\xc2\xff\x97',
        )
        .binary_regex_replace(
            re.escape(b'\xff\x03\x00\xf9\x28\x10\x40\xf9\x04\x2c\x40\xb9\x01\x89\x40\x29\x39\xc2\xff\x97'),
    ...
    'vendor/lib64/vendor.qti.hardware.camera.offlinecamera-service-impl.so': blob_fixup()
        ...
        .binary_regex_replace(
            re.escape(b'\x95\x19\x40\xf9\xbb\x1e\x40\xb9\xa0\x0e\x40\xb9'),
